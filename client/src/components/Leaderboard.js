...
function LeaderBoard() {
  ...
  return (
		<div class="overflow-x-auto" style={{ "min-height": "91vh" }}>
			<div class=" flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
				<div class="w-full lg:w-5/6 flex-col justify-center">
					<div class="flex justify-center p-5">
						<img class="h-28 w-28" src={winner} alt="trophy"></img>
					</div>
					<div class="bg-white shadow-md rounded my-6">
						<table class="min-w-max w-full table-auto">
							...
							<tbody class="text-gray-600 text-sm font-light">
								{!check && (
									<>
										<tr class="border-b border-gray-200 hover:bg-gray-100 animate-pulse">
											<td class="py-3 px-6 text-left">
												<div class="flex items-center">
													<div class="mr-2">
														<div class="w-36 h-6 rounded-full bg-gray-400" />
													</div>
												</div>
											</td>
											...
											<td class="py-3 px-6 text-center font-medium flex  justify-center">
